...
const siteData = {
  ...
  about: { title: 'About', eyebrow: 'Profile', intro: "Hi, I'm Devesh, a graphic and UI/UX designer specializing in logo design and branding. I create clean, user-focused digital experiences and impactful brand identities that help businesses stand out and communicate effectively. Through Designs by Devesh, I showcase my portfolio and offer professional services in graphic design, UI/UX design, logo design, and branding.", story: ['My practice focuses on building premium visual systems through typography, composition, motion, and atmosphere.', 'I create brand identities, packaging, campaign visuals, and digital content with a balance of clarity and artistic character.', 'Each project is shaped with attention to structure, tactile detail, and visual rhythm to create memorable experiences.', 'From concept to execution, I aim to transform ideas into work that feels timeless, immersive, and visually distinct.'] },
